...
import com.example.isweixin.ContactPerson.ContactsFragment;
import com.example.isweixin.ContactPerson.PinyinUtils;
import com.example.isweixin.information.SmsFragment;
...
public class Utils {
	...
	public static void DeleteContact(String ContactId) {
		// Uri uri =
		// Uri.withAppendedPath(ContactsContract.CommonDataKinds.Phone.CONTENT_URI
		// , ContactId);
