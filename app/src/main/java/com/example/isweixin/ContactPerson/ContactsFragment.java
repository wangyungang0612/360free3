package com.example.isweixin.ContactPerson;
...
import com.example.M360.AddContactsActivity;
...
//												} else if (which == 2) {
		...
		// 新增联系人
		m_AddContactBtn = (Button) ContactsView.findViewById(R.id.add_contacts1);
